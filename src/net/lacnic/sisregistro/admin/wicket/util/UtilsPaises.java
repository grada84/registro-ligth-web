...
//		this.listaPaises = new ArrayList<Pais>();
		this.nombrePaises = new ArrayList<String>();
		this.idPaises = new ArrayList<String>();

		String[] arrayPais = charPais.split(";");

		for (String var : arrayPais) {
			String[] var2 = var.split(":");
//			this.listaPaises.add(new Pais(var2[0], var2[1]));
	...
	public Pais getPais(String idoNombre) {
...
//	public Pais getPaisStatic(String id) {
//
//		for (int j = 0; j < listaPaises.size(); j++) {
//			Pais pais = listaPaises.get(j);
//
